...
describe("content.service", () => {
  ...
  describe("createContentService", () => {
    it("콘텐츠를 생성하고 ContentDetailResponse를 반환한다", async () => {
  ...
  describe("getContentByIdService", () => {
    ...
    it("삭제된 콘텐츠면 CONTENT_NOT_FOUND 실패 Result를 반환한다", async () => {
      const content = createMockContent({
        status: "DELETED",
      });
  ...
  describe("updateContentService", () => {
    it("콘텐츠가 없으면 CONTENT_NOT_FOUND 실패 Result를 반환한다", async () => {
      ...
      const result = await updateContentService("missing-content-id", {
        title: "수정된 제목",
      });
    ...
    it("삭제된 콘텐츠면 CONTENT_NOT_FOUND 실패 Result를 반환한다", async () => {
      ...
      const result = await updateContentService("content-id", {
        title: "수정된 제목",
      });
  ...
  describe("softDeleteContentService", () => {
    it("콘텐츠가 없으면 CONTENT_NOT_FOUND 실패 Result를 반환한다", async () => {
      ...
      const result = await softDeleteContentService("missing-content-id");
    ...
    it("이미 삭제된 콘텐츠면 CONTENT_NOT_FOUND 실패 Result를 반환한다", async () => {
      const content = createMockContent({
        status: "DELETED",
      });
      ...
      const result = await softDeleteContentService("content-id");
