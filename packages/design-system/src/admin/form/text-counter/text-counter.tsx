...
const baseTextCounterVariants = cva("text-muted-foreground text-xs", {
  variants: {
    align: {
      start: "text-left",
      center: "text-center",
...
export interface BaseTextCounterProps
  extends
    HTMLAttributes<HTMLSpanElement>,
    Omit<VariantProps<typeof baseTextCounterVariants>, "overLimit"> {
...
const BaseTextCounter = forwardRef<HTMLSpanElement, BaseTextCounterProps>(
  (
    {
      className,
      value,
...
BaseTextCounter.displayName = "TextCounter";
...
export interface TextCounterProps
  extends BaseTextCounterProps, VariantProps<typeof textCounterVariants> {}
