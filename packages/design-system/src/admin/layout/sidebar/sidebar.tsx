...
const Sidebar = forwardRef<HTMLElement, SidebarProps>(({ className, ...props }, ref) => {
  return <BaseSidebar ref={ref} className={cn("bg-surface/95", className)} {...props} />;
});
...
export const SidebarHeader = forwardRef<HTMLDivElement, SidebarHeaderProps>(
  ({ className, ...props }, ref) => {
    return <BaseSidebarHeader ref={ref} className={cn("bg-surface/80", className)} {...props} />;
  },
);
...
export const SidebarFooter = forwardRef<HTMLDivElement, SidebarFooterProps>(
  ({ className, ...props }, ref) => {
    return <BaseSidebarFooter ref={ref} className={cn("bg-surface/80", className)} {...props} />;
  },
);
