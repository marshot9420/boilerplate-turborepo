...
describe("Admin StatCard", () => {
  ...
  it("size, tone, interactive 상태를 전달한다", () => {
    ...
    expect(card).toHaveClass("hover:bg-muted/40");
  });
  ...
  it("admin title 스타일을 적용한다", () => {
    render(<StatCardTitle>STATUS</StatCardTitle>);
  ...
  it("className을 병합한다", () => {
    ...
    expect(screen.getByTestId("stat-card")).toHaveClass("rounded-lg");
