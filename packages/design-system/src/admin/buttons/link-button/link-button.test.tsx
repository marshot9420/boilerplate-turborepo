...
describe("Admin LinkButton", () => {
  it("link button을 렌더링한다", () => {
    render(<LinkButton href="/admin/contents">콘텐츠</LinkButton>);
    ...
    expect(link).toHaveAttribute("href", "/admin/contents");
    expect(link).toHaveAttribute("data-ds-component", "link-button");
  });

  it("admin link button 스타일을 적용한다", () => {
    render(<LinkButton href="/admin/contents">콘텐츠</LinkButton>);
    ...
    expect(link).toHaveClass("shadow-none");
  });
  ...
  it("variant, size, fullWidth 상태를 전달한다", () => {
    render(
      <LinkButton fullWidth href="/admin/contents" size="lg" variant="outline">
        수정
      </LinkButton>,
    );
  ...
  it("disabled 상태면 aria-disabled와 tabIndex를 적용한다", () => {
    render(
      <LinkButton disabled href="/admin/contents">
        콘텐츠
      </LinkButton>,
    );
  ...
  it("disabled 상태면 클릭 이벤트를 호출하지 않는다", async () => {
    ...
    render(
      <LinkButton disabled href="/admin/contents" onClick={handleClick}>
        콘텐츠
      </LinkButton>,
    );
  ...
  it("className을 병합한다", () => {
    render(
      <LinkButton className="custom-class" href="/admin/contents">
        콘텐츠
      </LinkButton>,
    );
  ...
  it("ref를 전달한다", () => {
    ...
    render(
      <LinkButton ref={ref} href="/admin/contents">
        콘텐츠
      </LinkButton>,
    );
  ...
  it("클릭 이벤트를 호출한다", async () => {
    ...
    render(
      <LinkButton href="/admin/contents" onClick={handleClick}>
        콘텐츠
      </LinkButton>,
    );
