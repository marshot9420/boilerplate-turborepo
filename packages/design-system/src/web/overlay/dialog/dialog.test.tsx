...
describe("Web Dialog", () => {
  it("trigger를 클릭하면 dialog를 연다", async () => {
    ...
    render(
      <Dialog>
        ...
        <DialogContent>
          ...
          <DialogDescription>웹 다이얼로그 설명</DialogDescription>
        </DialogContent>
      </Dialog>,
    );
    ...
    expect(screen.getByText("웹 다이얼로그")).toBeInTheDocument();
    expect(screen.getByText("웹 다이얼로그 설명")).toBeInTheDocument();
  });
  ...
  it("접근성 속성으로 title과 description을 연결한다", async () => {
    ...
    render(
      <Dialog>
        <DialogTrigger>열기</DialogTrigger>
        <DialogContent>
          <DialogTitle>웹 제목</DialogTitle>
          <DialogDescription>웹 설명</DialogDescription>
        </DialogContent>
      </Dialog>,
    );
    ...
    expect(dialog).toHaveAccessibleName("웹 제목");
    expect(dialog).toHaveAccessibleDescription("웹 설명");
  });
});
