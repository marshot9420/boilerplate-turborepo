...
describe("Web Accordion", () => {
  ...
  it("web accordion 스타일을 적용한다", () => {
    ...
    expect(accordion).toHaveClass("rounded-2xl");
    expect(accordion).toHaveClass("border");
    expect(accordion).toHaveClass("bg-surface");
    expect(accordion).toHaveClass("shadow-sm");
  ...
  it("className을 병합한다", () => {
    ...
    expect(screen.getByTestId("accordion")).toHaveClass("rounded-2xl");
