...
describe("Web DataList", () => {
  ...
  it("label과 value에 web 스타일을 적용한다", () => {
    render(
      <DataList>
        <DataListItem>
    ...
    expect(screen.getByText("상태")).toHaveClass("text-sm");
